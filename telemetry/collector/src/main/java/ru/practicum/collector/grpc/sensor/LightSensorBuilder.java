...
public class LightSensorBuilder extends AbstractSensorBuilder {
    ...
    public LightSensorBuilder(KafkaEventProducer kafkaEventProducer, SensorEventMapper sensorEventMapper) {
    ...
    public SensorEvent toSensorEvent(SensorEventProto sensorEvent) {
        ...
        lightSensorEvent.setTimestamp(Instant.ofEpochSecond(sensorEvent.getTimestamp().getSeconds(), sensorEvent.getTimestamp().getNanos()));
