...
public class ScenarioAddedEventAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ScenarioAddedEventAvro\",\"namespace\":\"ru.yandex.practicum.kafka.telemetry.event\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"conditions\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"ScenarioConditionAvro\",\"fields\":[{\"name\":\"sensor_id\",\"type\":\"string\"},{\"name\":\"type\",\"type\":{\"type\":\"enum\",\"name\":\"ConditionTypeAvro\",\"symbols\":[\"MOTION\",\"LUMINOSITY\",\"SWITCH\",\"TEMPERATURE\",\"CO2LEVEL\",\"HUMIDITY\"]}},{\"name\":\"operation\",\"type\":{\"type\":\"enum\",\"name\":\"ConditionOperationAvro\",\"symbols\":[\"EQUALS\",\"GREATER_THAN\",\"LOWER_THAN\"]}},{\"name\":\"value\",\"type\":[\"null\",\"int\"],\"default\":null}]}}},{\"name\":\"actions\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"DeviceActionAvro\",\"fields\":[{\"name\":\"sensor_id\",\"type\":\"string\"},{\"name\":\"type\",\"type\":{\"type\":\"enum\",\"name\":\"ActionTypeAvro\",\"symbols\":[\"ACTIVATE\",\"DEACTIVATE\",\"INVERSE\",\"SET_VALUE\"]}},{\"name\":\"value\",\"type\":[\"null\",\"int\"],\"default\":null}]}}}]}");
    private static final long serialVersionUID = 8902310264766853741L;
     ...
     */
    public ScenarioAddedEventAvro(java.lang.CharSequence name, java.util.List<ru.yandex.practicum.kafka.telemetry.event.ScenarioConditionAvro> conditions, java.util.List<ru.yandex.practicum.kafka.telemetry.event.DeviceActionAvro> actions) {
        this.name = name;
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            case 0:
                ...
                break;
            case 1:
                conditions = (java.util.List<ru.yandex.practicum.kafka.telemetry.event.ScenarioConditionAvro>) value$;
                break;
            case 2:
                actions = (java.util.List<ru.yandex.practicum.kafka.telemetry.event.DeviceActionAvro>) value$;
                break;
            default:
                throw new IndexOutOfBoundsException("Invalid index: " + field$);
        }
    ...
    public void customEncode(org.apache.avro.io.Encoder out)
        ...
        long size0 = this.conditions.size();
        out.writeArrayStart();
        out.setItemCount(size0);
        long actualSize0 = 0;
        for (ru.yandex.practicum.kafka.telemetry.event.ScenarioConditionAvro e0 : this.conditions) {
            actualSize0++;
            out.startItem();
            e0.customEncode(out);
        }
        ...
        long size1 = this.actions.size();
        out.writeArrayStart();
        out.setItemCount(size1);
        long actualSize1 = 0;
        for (ru.yandex.practicum.kafka.telemetry.event.DeviceActionAvro e1 : this.actions) {
            actualSize1++;
            out.startItem();
            e1.customEncode(out);
        }
    ...
    public void customDecode(org.apache.avro.io.ResolvingDecoder in)
        ...
        if (fieldOrder == null) {
            ...
            java.util.List<ru.yandex.practicum.kafka.telemetry.event.ScenarioConditionAvro> a0 = this.conditions;
            if (a0 == null) {
                a0 = new SpecificData.Array<ru.yandex.practicum.kafka.telemetry.event.ScenarioConditionAvro>((int) size0, SCHEMA$.getField("conditions").schema());
                this.conditions = a0;
            } else a0.clear();
            SpecificData.Array<ru.yandex.practicum.kafka.telemetry.event.ScenarioConditionAvro> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<ru.yandex.practicum.kafka.telemetry.event.ScenarioConditionAvro>) a0 : null);
            for (; 0 < size0; size0 = in.arrayNext()) {
                for (; size0 != 0; size0--) {
                    ru.yandex.practicum.kafka.telemetry.event.ScenarioConditionAvro e0 = (ga0 != null ? ga0.peek() : null);
                    if (e0 == null) {
                        e0 = new ru.yandex.practicum.kafka.telemetry.event.ScenarioConditionAvro();
                    }
                    e0.customDecode(in);
                    a0.add(e0);
                }
            ...
            java.util.List<ru.yandex.practicum.kafka.telemetry.event.DeviceActionAvro> a1 = this.actions;
            if (a1 == null) {
                a1 = new SpecificData.Array<ru.yandex.practicum.kafka.telemetry.event.DeviceActionAvro>((int) size1, SCHEMA$.getField("actions").schema());
                this.actions = a1;
            } else a1.clear();
            SpecificData.Array<ru.yandex.practicum.kafka.telemetry.event.DeviceActionAvro> ga1 = (a1 instanceof SpecificData.Array ? (SpecificData.Array<ru.yandex.practicum.kafka.telemetry.event.DeviceActionAvro>) a1 : null);
            for (; 0 < size1; size1 = in.arrayNext()) {
                for (; size1 != 0; size1--) {
                    ru.yandex.practicum.kafka.telemetry.event.DeviceActionAvro e1 = (ga1 != null ? ga1.peek() : null);
                    if (e1 == null) {
                        e1 = new ru.yandex.practicum.kafka.telemetry.event.DeviceActionAvro();
                    }
                    e1.customDecode(in);
                    a1.add(e1);
                }
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ScenarioAddedEventAvro>
         ...
         * @return This builder.
         */
        public ru.yandex.practicum.kafka.telemetry.event.ScenarioAddedEventAvro.Builder setName(java.lang.CharSequence value) {
